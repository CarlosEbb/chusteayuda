  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        {!! Form::open(['route'=>'incidencia.store', 'method'=>'POST','id' => 'form-incidencias', 'class'=>'d-flex justify-content-center align-items-center flex-column', 'files' => true, 'role' => 'form']) !!}
          <input type="text" id="cliente_id" name="cliente_id" hidden @if(isset($_GET['cliente_id'])) value="{{$_GET['cliente_id']}}" @endif>
