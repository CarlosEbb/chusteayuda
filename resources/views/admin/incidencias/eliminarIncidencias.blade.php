<div class="modal  fade border-0" id="modal-eliminar_{{$reporte->id}}" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        ...
        <p class="mb-0 fs-4 mt-3" >Desea eliminar ({{$reporte->nombre_empleado}})</p>
      ...
      <div class="modal-footer">
        ...
        {!! Form::open(['route' => ['incidencia.destroy', $reporte->id], 'method' => 'DELETE']) !!}
